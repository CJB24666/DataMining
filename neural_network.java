...
public class neural_network {
        ...
        public static void main(String[] args) throws Exception {
            ...
            for (String cur_instrument : instruments) {
                ...
                ConverterUtils.DataSource trainSource = new ConverterUtils.DataSource("C:/Users/chris/Documents/train/" + cur_instrument + ".arff");
                Instances trainData = trainSource.getDataSet();

                ConverterUtils.DataSource testSource = new ConverterUtils.DataSource("C:/Users/chris/Documents/test/" + cur_instrument + ".arff");
                ...
                classifier.setTrainingTime(200);
                ...
                for (int i = 0; i < testData.numInstances(); ++i) {
                    ...
                    saver.setFile(new File("C:/Users/chris/Documents/pred/Neural_network/" + cur_instrument + ".csv"));
                    saver.writeBatch();
